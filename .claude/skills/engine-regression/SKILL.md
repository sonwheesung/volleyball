...
## 기준 베이스라인 (노쇠 개편 후, 48k · 2026-07-01)

> 계수 변경 후 이 값에서 크게 벗어나면(±2%p↑) 원인을 규명한다. **엔진 로직을 바꾸면 이 베이스라인도 재측정·갱신**(STATS_PROTOCOL: 로직 변경 시 기존 통계 무효).
> 갱신 이력: 최초 37.11%(노쇠개편 전) → 노쇠 개편(ratings 물리가중↑·aging 포지션차등) 후 아래로 재측정. 절대 KOVO(simKovo 리그팀) 전항목 ✓ 유지.

```
분포:  공격성공률 36.92% · 블록아웃 2.19% · 스터프 6.27% · 공격범실 6.15%
       에이스 5.28% · 서브범실 8.56% · 리시브범실 3.06% · 디그율 45.32% · 랠리hop 1.533
ΔOVR 곡선:  0-1=50.4% · 1-3=59.7% · 3-5=72.5% · 5-7=80.1% · 7-9=88.7%
            9-11=93.1% · 11-13=96.0% · 13-16=98.5% · 16+=99.4%
q대칭:  Δrecv 2-5=55.5% ≈ Δspk 2-5=58.0% (대칭=리시브 독식 없음)
```
