...
- 표준편차: 한 팀 독식(예: 15+)이면 밸런스 결함. 5~7이면 건강(현 100시즌 고정시드 기준치 6.4 — 2026-06-12 체력 리워크 후에도 동일. 팁 직전 8.4였으므로 팁은 개선 방향. 과거 5.1은 KOVO 정렬 이전 수치라 비교 무효).
- 다중 유니버스(`simLeague 25 8`) 기준치: **σ 3.45±1.03 · 왕조 평균 6.3(최대 9) · 우승경험 5.5/7 ·
  꼴찌→우승 100%** (유니버스 8개 × 25시즌, 시즌당 풀 리그 재시뮬 · 엔진 d2f37a8 · 2026-06-14 — AI 팀 기본 스태프 추가 후).
  직전(민첩 노쇠 추가 후 σ 4.06/왕조 7.0/우승경험 5.1 · 엔진 d855401 · 2026-06-12)보다 σ·왕조 미세 하락,
  우승경험 상승 — AI 전 구단이 기본 스태프(코치2+스카우터1)로 균일하게 성장 → 랜덤 발산 감소로 parity 개선(의도 방향).
  워치: 왕조 평균 8 초과 시 보정 착수.
  ※ 유니버스 단위(n=8)는 STATS_PROTOCOL 예외(도달 불가 단위) — 산하 표본을 함께 명기한다.
