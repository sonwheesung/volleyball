...
- 다중 유니버스(`simLeague 25 8`) 기준치: **σ 4.06±0.91 · 왕조 평균 7.0(최대 11) · 우승경험 5.1/7 ·
  꼴찌→우승 100%** (유니버스 8개 × 25시즌, 시즌당 풀 리그 재시뮬 · 엔진 d855401 · 2026-06-12 — 민첩 노쇠 추가 후).
  직전(체력 리워크 후 σ 3.93/왕조 6.6/반등 88% · 엔진 d2a5eb5)보다 σ·왕조 미세 상승하나 반등은 88→100% —
  민첩 노쇠로 수비형 노장이 더 빨리 쇠퇴 → 세대교체 활발(의도된 방향). 워치: 왕조 평균 8 초과 시 보정 착수.
