...
- 다중 유니버스(`simLeague 25 8`) 기준치: **σ 3.93±0.84 · 왕조 평균 6.6(최대 11) · 우승경험 5.3/7 ·
  꼴찌→우승 88%** (유니버스 8개 × 25시즌, 시즌당 풀 리그 재시뮬 · 엔진 d2a5eb5 · 2026-06-12).
  체력 무효 시절(3.24/5.6/6.0/100% · 엔진 d9f7b0d)보다 전 지표가 "강자 유리" 쪽 ~1σ 이동 —
  체력 유효화의 의도된 대가(5세트 접전을 강팀이 더 가져감 → 업셋 노이즈 감소). 워치: 왕조 평균 8 초과 시 보정 착수.
