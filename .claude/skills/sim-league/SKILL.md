...
- 다중 유니버스(`simLeague 25 8`) 기준치: **σ 3.28±0.57 · 왕조 평균 4.6(최대 7) · 우승경험 5.9/7 ·
  꼴찌→우승 100%** (유니버스 8개 × 25시즌, 시즌당 풀 리그 재시뮬 · 2026-06-14 — 반응속도 가중 재밸런스 후).
  직전(AI 기본 스태프 후 σ 3.45/왕조 6.3/우승경험 5.5 · 엔진 d2f37a8)보다 σ·왕조 하락, 우승경험 상승 —
  반응속도가 리시브·디그·블록 3종에 깔려 단일 스탯 쏠림을 키우던 걸 완화(ratings.ts)하니 전력 발산 감소로 parity 개선.
