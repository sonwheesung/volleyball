...
- 다중 유니버스(`simLeague 25 8`) 기준치(2026-06-12 체력 리워크 후): σ 3.60±0.95 · 왕조 평균 6.9(최대 10) · 우승경험 5.4/7 · 꼴찌→우승 88%.
  체력 이전(3.24/5.6/6.0/100%)보다 전 지표가 "강자 유리" 쪽으로 ~1σ 이동 — 체력 유효화의 의도된 대가
  (5세트 접전을 강팀이 더 가져감 → 업셋 노이즈 감소). 고정시드 100시즌 왕조 11연패 단일 관측은 워치 —
  다음 밸런스 작업에서 왕조 평균이 8을 넘으면 보정 착수.
