...
> ⚠ **재정 회귀 발견(2026-06-27, 문서-코드 일관성 검사)** — 아래 2026-06-14 검증값은 **stale·무효(STATS_PROTOCOL)**.
> 현재 엔진(HEAD) `tools/simFinance.ts` 120시즌 재측정: **잔고 평균 1.6억**(0~20.1억)·**모기업 보전 60회(50%)**·
> **캡OK·자금부족 좌절 91회/115**(영입 성사 25)·**"❌ 재정 튜닝 필요"**. 팀이 만성 적자라 FA 영입이 막힘 →
> **단장 결정(FA) 기둥 저해 — 별도 재정 튜닝 작업 필요.** 원인 추정: 구단 정체성(2026-06-18, 선수단 강·약/나이/포텐
> 분화)·이후 성장/노쇠 변경으로 연봉 대비 수입 마진 악화. (~~잔고 9.9억·보전 23회(19%)·parity 유지, 엔진 49ccb61·2026-06-14~~)
> 모기업 베이스 20~28→22~30억 상향 이력은 유지하나 그 시점 기준선은 무효 — 재튜닝 시 재측정.
