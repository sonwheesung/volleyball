...
> 검증: `tools/simFinance.ts` 120시즌 — 잔고 평균 **8.0억**(0~33.6억, 유계), 모기업 보전 **9회(8%)**,
> 캡OK·자금부족 좌절 **21회/96**(영입 성사 68 — 드라마 생존), ✅ 재정 건강 (엔진 HEAD · 2026-06-27).
> **모기업 베이스 22~30→25~33억 재상향(+3억)** — 회귀 수정:
