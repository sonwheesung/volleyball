...
npx tsx tools/_dv_diamonds.ts               # 다이아 이코노미(MONETIZATION §11) — 광고 ~~30분~~2시간쿨다운(2026-07-17 사용자 결정)/하루8회·업적 1회수령(중복지급0)·전지훈련 구모델(+1/+1, 재적용 전용)+코스형(3스탯 +3/+3 대칭·H1 스탯구성·300💎 정액·cap99) + A/B(쿨다운 무력 검출). exit 0/1
