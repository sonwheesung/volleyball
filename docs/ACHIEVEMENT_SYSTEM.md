...
- **서사(9)**: 10/15연승 · 10연패 · 모든 순위 경험 · 최하위의 반란(꼴찌 이듬해 가을야구) ·
  꼴찌 3연속 · 만년 2위(2위 3회) · 가을 단골(3위 이내 10회) · 3위 이내 5연속
...
- 결과(120시즌, 56개 카탈로그): 비운영 **51종 전부 도달 가능**(51/51), 진행 타임라인 현실적.
  운영 5종(자금 3·팬심 2)은 구단주 레이어(앱 플레이) 소관이라 리그 시뮬 밖.
- **발견·수정(2026-06-13)**:
