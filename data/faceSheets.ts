...
export const FACE_SHEETS: FaceSheet[] = [
  ...
  { src: require('../assets/players/faces15.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces16.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces17.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces18.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces19.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces20.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces21.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces22.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces23.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces24.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces25.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces26.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces27.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces28.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces29.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces30.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces31.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces32.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces33.png'), cols: 3, rows: 3, count: 9 },
  { src: require('../assets/players/faces34.png'), cols: 3, rows: 3, count: 9 },
];
