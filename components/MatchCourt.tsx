...
import type { SimResult, TimeoutEvent, SubKind } from '../engine/simMatch';
...
const SUB_KIND_KO: Record<SubKind, string> = { pinch: '서브 보강', block: '블로킹 보강', def: '수비 보강', injury: '몸 상태 · 교체', rest: '체력 안배', manual: '교체' };
