    ...
    <main style={{ maxWidth: 760, margin: '0 auto', padding: 32 }}>
      ...
      <section style={card}>
        ...
        <ul style={li}>
          ...
          <li>
            <strong>게임 이용 통계(운영 행동)</strong>: 서비스 개선을 위해 시즌 종료 시 게임 운영 행동의 비식별 집계 수치(경기 개입·교체·타임아웃
            횟수, 선수 방출·전지훈련 이용 수, 순위·우승 여부 등)를 수집합니다. 개인을 식별할 수 없는 통계 수치이며 가상 선수·구단 기록에
            한정됩니다.
          </li>
          <li>
