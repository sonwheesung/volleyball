  ...
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: 32 }}>
      ...
      <section style={card}>
        ...
        <ul style={li}>
          <li>
            ...
            <strong>이메일 주소</strong>. 이름·프로필 사진은 수집·저장하지 않습니다.
          </li>
          <li>
      ...
      <section style={card}>
        ...
        <ul style={li}>
          <li>계정 식별 및 로그인, 기기 변경 시 재화·구매 내역의 연속성 유지. 이메일 주소는 계정 식별과 고객 지원(문의·결제 확인 시 본인 계정 확인)에 이용</li>
      ...
      <section style={card}>
        ...
        <p style={muted}>
          ...
          차단되고 비필수 정보(이메일 주소·표시 이름 등)는 우선 파기됩니다. 위 법정 보존 대상은 개인을 식별할 수 없도록 처리하여 보존기간
          만료 후 파기합니다.
        </p>
      </section>
      ...
      <p style={{ ...muted, marginTop: 24, fontSize: 13 }}>시행일 2026-07-17 · 최종 수정 2026-08-08</p>
    </main>
  );
}
