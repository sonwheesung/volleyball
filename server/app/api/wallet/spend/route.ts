...
// camp=−200 서버상수(클라 amount 무시 — amount=1 보내도 200 강제, 인하 900→300(2026-07-06)→200(2026-07-17)). reason 화이트리스트로 camp만 허용.
...
export async function POST(req: Request) {
  try {
    ...
    const amount = spendAmount(reason); // 서버 권위(−200 강제)
