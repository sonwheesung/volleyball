    ...
    <Screen title="게임 가이드">
      ...
      <Card>
        <Accordion icon="person-outline" title="감독: 팀 전체를 좌우하는 사람">
          ...
          <Line k="카리스마" v="작전타임 효과가 얼마나 큰지, 그리고 구단주의 건의를 들어줄지 거절할지를 좌우해요." />
          <Line k="훈련 방향" v="감독이 선호하는 능력치를 팀이 집중해서 키워요. 즉 우리 팀이 앞으로 어떤 방향으로 성장할지를 정해요." />
          <P>그래서 감독을 바꾸면 팀의 성장 방향·경기 성향·작전타임 효과·건의를 받아주는 정도가 한꺼번에 바뀌어요. 감독이 마음에 안 들면 교체하는 것, 그게 구단주가 팀을 바꿀 수 있는 가장 강력한 카드예요.</P>
        </Accordion>
        ...
        <Accordion icon="globe-outline" title="외국인: 트라이아웃">
          ...
          <P>이미 다 큰 선수라서 잠재력보다는 예전에 얼마나 잘했는지(다른 리그 성적·수상·부상·적응)를 보고 뽑아요. 팀 전력을 가장 크게 바꾸는 결정이라, 외국인 한 명이 시즌 성패를 좌우해요.</P>
        </Accordion>
