    ...
    <Screen title="게임 가이드">
      ...
      <Card flat>
        <Accordion icon="tv-outline" title="이게 무슨 게임이에요? (보는 게임)">
          ...
          <P>구단주는 어떤 선수를 데려오고, 누구와 다시 계약하고, 어떤 감독에게 팀을 맡길지 같은 큰 결정을 해요. 선발과 벤치도 직접 정하고, 정규시즌 내 팀 경기는 보면서 교체·타임아웃으로 개입할 수도 있어요(원할 때만 — 안 하면 감독이 알아서 해요). 플레이오프·챔프전 같은 큰 경기는 관전만 해요. 좋은 결정이 쌓이면 팀이 강해지고, 세월이 흐르면 그게 우리 구단의 역사가 돼요.</P>
        </Accordion>
        <Accordion icon="sync-outline" title="한 시즌은 이렇게 흘러가요">
          <P>아래 순서가 시즌마다 계속 반복돼요. 큰 결정은 대부분 경기가 없는 '오프시즌'에 몰려 있어요.</P>
          <Line k="① 오프시즌" v="팀을 꾸리는 준비 기간이에요. 일정 화면의 준비 목록에서 시즌 결산 · 외국인 트라이아웃 · 아시아쿼터 · FA · 신인 드래프트를 권장 순서대로 열어볼 수 있어요. 순서는 자유고, 건너뛴 자리는 감독·스카우트가 대신 결정해요. 새 시즌을 시작하면 헌액 · 전지훈련을 거쳐 개막해요." />
          <Line k="② 개막·경기" v="정해진 일정대로 경기가 자동으로 진행돼요. 내 팀 경기는 언제든 직접 관전할 수 있고, 놓치면 아까운 경기는 빅매치로 표시돼요." />
          <Line k="③ 포스트시즌" v="정규 일정이 끝나면 상위 3팀이 플레이오프·챔피언결정전을 치러 그 시즌 우승팀을 가려요. 내 팀이 오르면 직접 관전할 수 있어요." />
      ...
      <Card flat>
        ...
        <Accordion icon="flame-outline" title="빅매치: 볼 만한 경기를 알려줘요">
          <P>순위에 크게 영향을 주는 경기는 ⭐중요·🔥빅매치로 표시돼요. 상위권 팀끼리 붙거나, 라이벌(숙적)과 만나거나, 시즌 막판에 순위가 비슷한 팀과 접전할 때예요.</P>
        ...
        <Accordion icon="clipboard-outline" title="선발·교체·타임아웃: 누가 정하나">
          ...
          <P>정규시즌 내 팀 경기는 관전할 때 직접 개입할 수 있어요(원할 때만). 경기 중에 타임아웃을 부르거나 선수를 교체하는 거예요. 플레이오프·챔프전 같은 큰 경기는 관전만 하고, 개입은 없어요.</P>
          <P>기본은 '감독 자동'이라, 개입하지 않으면 감독이 타임아웃·교체를 알아서 다 해줘요 — 안심하고 지켜봐도 돼요. 설정 → 경기 지휘에서 '구단주 직접'으로 바꾸면, 내가 관전하지 않은 내 팀 경기는 타임아웃·교체 없이 진행돼 불리할 수 있으니 그때만 주의하세요.</P>
      ...
      <Card flat>
        <Accordion icon="stats-chart-outline" title="스탯: 능력치는 2층으로 되어 있어요">
          ...
          <P>· 신체: 키·점프력·민첩성·체력·체력재생  · 공통: 반응속도·위치선정  · 멘탈: 집중력·기복·배구IQ</P>
          <P>체력은 경기 동안 버티는 총량이고, 체력재생은 그 체력이 다시 차오르는 속도예요. 그래서 후반에 무너지는 선수와, 금방 회복해 체력 승부에 강한 선수가 갈려요.</P>
        ...
        <Accordion icon="sparkles-outline" title="특성: 타고난 개성">
          <P>선수 중에는 타고난 특성을 가진 이가 있어요. 좋은 특성은 흔하고 나쁜 특성은 드물어요. 그래서 유망주를 데려오는 건 될지 안 될지 모르는 도박이라 더 재밌고, 세월이 쌓이면 그 선수만의 이야기가 돼요.</P>
        ...
        <Accordion icon="pulse-outline" title="컨디션: 경기감각">
          ...
          <P>부상에서 돌아오거나 오랜만에 다시 뛸 때는 감각을 되찾는 데 시간이 좀 걸려요. 선수 화면에는 "경기감각 좋음 / 감각 살짝 무뎌짐 / 실전 감각 녹슮" 세 단계로 표시돼요.</P>
        </Accordion>
        ...
        <Accordion icon="people-outline" title="인간관계: 친한·라이벌">
          <P>선수들은 서로 친하기도 하고(친한) 같은 포지션에서 경쟁하기도 해요(라이벌). 같은 팀에 친한 선수가 있으면 그 팀에 더 오고 싶어 하고 잘 남으려 해요 — 경기 실력과는 별개고, 영입·재계약에서 작용해요. 반대로 라이벌이 뛰는 팀은 꺼려요. 아끼던 선수를 방출하면 친했던 동료들이 동요해 재계약을 망설이기도 해요. 이런 관계는 국내 선수끼리만 생기고, 1년 계약인 수입 선수에게는 없어요.</P>
        </Accordion>
      </Card>
      ...
      <Card flat>
        <Accordion icon="diamond-outline" title="다이아: 어떻게 얻나요">
          ...
          <Line k="📺 광고 시청" v={`광고를 끝까지 보면 +${AD_REWARD} 다이아를 받아요 (2시간 간격, 하루 ${AD_DAILY_CAP}회까지). '광고 제거'를 사면 광고를 보지 않고 바로 받아요(2시간 간격·하루 횟수는 그대로예요).`} />
      ...
      <Card flat>
        <Accordion icon="person-outline" title="감독: 팀 전체를 좌우하는 사람">
          <P>감독은 평소 경기 중 결정(교체·타임아웃·작전)을 자동으로 맡아요. 선발·벤치는 구단주가 직접 정하고 내 팀 경기는 볼 때 직접 개입할 수도 있지만(위 '선발·교체·타임아웃' 항목), 개입하지 않으면 감독이 알아서 다 해줘요. 그래서 어떤 감독을 앉히느냐에 따라 팀이 통째로 달라져요.</P>
          <P>감독의 실력은 세 가지 능력으로 나뉘어요. 각각이 서로 다른 곳에 영향을 줘요.</P>
          <Line k="경기 운영" v="작전타임(타임아웃)의 효과가 얼마나 큰지를 좌우해요. 높을수록 흐트러진 팀 분위기를 더 잘 다잡아요." />
          <Line k="육성 철학" v="어린 선수(U23)에게 코트를 얼마나 내주는지예요. 높을수록 실력이 근소하게 앞서는 자리에 유망주를 먼저 기용하고, 그 유망주가 경기로 얻는 경험도 조금 더 커요. (성장 자체는 코치의 몫이에요.)" />
          <Line k="리더십" v="선수단을 다독이는 힘이에요. 벤치 선수의 경기감각 하락을 덜어 주고, 선수 불만이 덜 쌓이게 하고, 선수 면담 성공률과 선발·벤치 건의를 받아들이는 정도에 영향을 줘요." />
          <P>이 세 능력을 합친 게 감독 종합(OVR)이에요. 능력 프로필에 따라 승부형·육성형·조직관리형 같은 유형으로 보여 줘요.</P>
          <Line k="성향" v="공격형·수비형·밸런스. 경기에서 어떤 전술과 스타일로 싸울지를 정해요." />
          <Line k="훈련 방향" v="감독이 선호하는 능력치를 팀이 집중해서 키워요. 즉 우리 팀이 앞으로 어떤 방향으로 성장할지를 정해요." />
          <P>그래서 감독을 바꾸면 팀의 성장 방향·경기 성향·경기 운영이 한꺼번에 바뀌어요. 감독이 마음에 안 들면 교체하는 것, 그게 구단주가 팀을 바꿀 수 있는 가장 강력한 카드예요.</P>
        </Accordion>
        <Accordion icon="star-outline" title="감독 명성: 실력과는 다른 시장 가치">
          <P>명성은 감독이 시장에서 얼마나 '쳐주는' 값인지예요. 실력(위 세 능력)과는 별개라서, 실력은 좋은데 명성은 낮은 무명 감독도, 왕년에 이름을 날렸지만 이제 실력은 평범한 거장도 있어요. 이 괴리 자체가 영입 판단의 재미예요.</P>
          <P>명성은 능력치가 아니라서 경기 결과에는 영향을 주지 않아요. 대신 이런 걸 좌우해요.</P>
          <Line k="💰 연봉" v="명성이 높을수록 실력 기준 연봉 위에 프리미엄이 얹혀서 재계약 요구가 비싸져요." />
          <Line k="👀 관심 구단" v="명성이 높은 감독은 계약이 풀리면 여러 구단이 노려요(놓아주기 경고에 표시돼요)." />
          <Line k="🤝 선수·관중" v="명장이 이끄는 팀은 FA 선수 유인과 관중이 아주 소폭 늘어요." />
          <Line k="📰 뉴스" v="명성이 높은 감독의 데뷔·이적·헌액이 뉴스로 다뤄져요." />
          <P>명성은 어떻게 오르나요? 핵심은 '기대 대비 성적'이에요. 예상 순위보다 잘하면 오르고, 못하면 내려가요(꼴찌라도 예상대로면 깎이지 않아요 — 약체를 예상대로 이끈 감독을 벌하지 않아요). 우승·정규 1위·유망주 육성도 조금씩 보태져요. 티어는 무명 → 주목 → 인정받는 감독 → 명장 → 거장(★)으로 올라가요.</P>
        </Accordion>
        <Accordion icon="newspaper-outline" title="언론 예상 순위: 시즌의 기준선">
          <P>매 시즌 개막 전, 전력을 바탕으로 전 구단의 예상 순위가 뉴스로 공개돼요. 이게 그냥 재미 요소가 아니라, 감독을 평가하는 기준선이에요.</P>
          <P>예상 7위였는데 4위로 끌어올리면 감독 명성이 오르고, 예상 2위였는데 5위에 그치면 내려가요. 그래서 '예상보다 얼마나 잘했나'가 그대로 눈에 보여요.</P>
        </Accordion>
        <Accordion icon="document-text-outline" title="감독 재계약·놓아주기·카운터오퍼">
          <P>감독도 계약 기간이 있어요. 계약이 얼마 안 남으면 스태프 화면에서 요구 연봉과 그 이유(우승·기대 이상 성적 등)를 보여 줘요. 세 가지 중 하나를 고를 수 있어요.</P>
          <Line k="재계약" v="요구 연봉을 받아들여 계약을 이어가요." />
          <Line k="카운터오퍼" v="요구보다 낮은 금액을 한 번 제시해요. 명성이 높거나·노리는 구단이 많거나·너무 많이 깎으면 결렬돼서 감독이 FA로 떠날 수 있어요(딱 한 번뿐)." />
          <Line k="놓아주기" v="감독을 FA로 풀어 줘요. 명성이 높으면 다른 구단이 데려갈 수 있어요(관심 구단을 경고로 보여 줘요)." />
        </Accordion>
        <Accordion icon="swap-horizontal-outline" title="FA: 자유계약">
          ...
          <P>선수의 성격·팀 성적·내가 제시한 연봉에 따라 선택이 달라져요. 선수를 맞바꾸는 트레이드는 없어요. 선수는 FA·드래프트·수입 선수(외국인·아시아쿼터)로만 데려와요.</P>
          <P>등급이 높은(A·B) FA를 다른 팀에서 데려오면, 보호명단에 넣지 않은 선수 한 명을 보상선수로 내주거나 보상금을 내요. 그래서 꼭 지키고 싶은 선수는 미리 보호명단에 넣어 둬요.</P>
        </Accordion>
        ...
        <Accordion icon="globe-outline" title="외국인 · 아시아쿼터: 수입 선수 둘">
          ...
          <P>수입 선수는 1년 계약이라 매 시즌 다시 데려와요. 국내 선수 같은 방출·재계약 흐름의 대상이 아니고, 새로 뽑거나 시즌 중 교체로만 손대요.</P>
        ...
        <Accordion icon="search-outline" title="스카우터: 정보를 밝혀 주는 사람">
          <P>스카우터는 아직 우리 팀이 아닌 선수들(드래프트 유망주·외국인 후보·다른 팀 FA 선수)의 정보를 알아봐 주는 사람이에요.</P>
      ...
      <Card flat>
        <Accordion icon="wallet-outline" title="운영자금: 구단주의 지갑">
          <P>운영자금은 구단을 운영하는 데 실제로 쓰는 구단주의 지갑이에요. 선수 연봉의 상한을 정하는 샐러리캡(모든 구단이 똑같이 지키는 규칙)과는 다른 개념이에요 — 샐러리캡은 '규칙'이고, 운영자금은 실제로 쓰는 '돈'이라 선수 연봉도 여기서 나가요.</P>
          <P>이렇게 돈이 들어와요(수입):</P>
          <Line k="🏢 모기업 지원" v="가장 큰 몫이에요. 팀마다 지원 크기가 달라요." />
          <Line k="🎟️ 관중 수입" v="성적이 좋으면 관중이 늘어서 수입도 늘어요." />
          <Line k="👕 굿즈" v="인기 스타가 있으면 상품이 팔려서 돈이 들어와요." />
          <P>이렇게 돈이 나가요(지출):</P>
          <Line k="🏐 선수 연봉" v="국내·수입 선수 전원의 연봉이 나가요. 지출에서 가장 큰 몫이에요." />
          <Line k="🧑‍🏫 스태프 계약" v="코치·스카우터와 계약하는 데 들어요." />
          <Line k="🏟️ 구단 운영비" v="시설·프런트 운영 등 기본 운영비가 매 시즌 들어요." />
          <P>모기업은 부족한 돈을 메꿔주는 곳이라서, 지갑에 돈이 많이 남아 있으면 지원을 줄여요. 그래서 운영자금이 끝없이 쌓이지는 않아요.</P>
          <P>참고로 FA 센터에서 보는 '가용 자금'은 지금 이 운영자금과 달라요. 이번 시즌이 끝나 선수단 연봉이 빠진 뒤에 FA에 쓸 수 있는 예상 금액이라, 지금 잔고보다 대체로 적게 보여요.</P>
        </Accordion>
        <Accordion icon="heart-outline" title="팬심: 팬 관리가 곧 돈이에요">
          <P>팬심은 팬들의 마음이에요. 팀이 이기고 우승하면 올라가고, 인기 선수를 오랫동안 벤치에 앉혀 두거나 방출하면 내려가요.</P>
          <P>팬심은 관중 수입을 통해 다음 시즌 운영자금에 보태져요(다만 성적이 더 크게 좌우해요). 팬이 많아지면 경기장을 찾는 사람도, 구단에 들어오는 돈도 늘어나거든요. 그래서 팬을 잘 관리하는 게 결국 돈이 돼요. 성적만큼이나 인기 선수를 아끼는 게 중요해요.</P>
          <P>팬심이 바닥까지 떨어지면 선수들도 팀을 떠나고 싶어해요.</P>
        </Accordion>
      </Card>
      ...
      <Card flat>
        ...
        <Accordion icon="clipboard-outline" title="명장 열전: 감독의 명예의전당">
          <P>선수만 명예의전당이 있는 게 아니에요. 오래 재직하며 명성을 쌓고 좋은 성적을 낸 감독은, 은퇴하면 '명장 열전'에 이름을 올려요(기록 &gt; 명예의전당 탭에서 볼 수 있어요).</P>
          <P>재직 시즌·우승 횟수·최고 명성·대표 시즌('예상 6위 → 우승' 같은)이 함께 남아서, 우리 구단을 거쳐 간 명장들의 발자취가 세월이 지나도 이어져요. 감독에게는 등번호(헌액 번호) 대신 명성으로 기려요.</P>
        </Accordion>
      </Card>
