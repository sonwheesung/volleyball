    ...
    <Screen title="게임 가이드">
      ...
      <Card flat>
        <Accordion icon="person-outline" title="감독: 팀 전체를 좌우하는 사람">
          <P>감독은 평소 경기 중 결정(교체·타임아웃·작전)을 자동으로 맡아요. 선발·벤치는 구단주가 직접 정하고 내 팀 경기는 볼 때 직접 개입할 수도 있지만(위 '선발·교체·타임아웃' 항목), 개입하지 않으면 감독이 알아서 다 해줘요. 그래서 어떤 감독을 앉히느냐에 따라 팀이 통째로 달라져요. 감독은 크게 세 가지를 결정해요.</P>
