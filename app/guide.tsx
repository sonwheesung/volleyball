    ...
    <Screen title="게임 가이드">
      ...
      <Card flat>
        <Accordion icon="tv-outline" title="이게 무슨 게임이에요? (보는 게임)">
          ...
          <P>구단주는 어떤 선수를 데려오고, 누구와 다시 계약하고, 어떤 감독에게 팀을 맡길지 같은 큰 결정을 해요. 선발과 벤치도 직접 정하고, 내 팀 경기는 보면서 교체·타임아웃으로 개입할 수도 있어요(원할 때만 — 안 하면 감독이 알아서 해요). 좋은 결정이 쌓이면 팀이 강해지고, 세월이 흐르면 그게 우리 구단의 역사가 돼요.</P>
        </Accordion>
