...
const SL_PROD: Record<string, ProdLine> = {
  maria:      { matches: 36, gamesPlayed: 36, sets: 128, points: 842, spikes: 712, backSpikes: 120, blocks: 48, aces: 38, assists: 12,   digs: 90,  receives: 20 },
  hanjiu:     { matches: 36, gamesPlayed: 36, sets: 128, points: 520, spikes: 360, backSpikes: 0,   blocks: 96, aces: 22, assists: 8,    digs: 70,  receives: 15 },
  osera:      { matches: 36, gamesPlayed: 36, sets: 128, points: 5,   spikes: 0,   backSpikes: 0,   blocks: 2,  aces: 4,  assists: 40,   digs: 421, receives: 540 },
  kimhaneul:  { matches: 36, gamesPlayed: 36, sets: 128, points: 60,  spikes: 18,  backSpikes: 0,   blocks: 20, aces: 24, assists: 1288, digs: 190, receives: 55 },
  munseoyeon: { matches: 36, gamesPlayed: 36, sets: 128, points: 480, spikes: 400, backSpikes: 40,  blocks: 30, aces: 28, assists: 10,   digs: 240, receives: 612 },
};
