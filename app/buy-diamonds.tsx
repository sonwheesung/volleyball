  ...
  return (
    <Screen>
      ...
      <Muted style={styles.note}>
        ...
        결제·다이아 잔액은 온라인에서 확인됩니다. 광고·업적으로도 다이아를 모을 수 있어요.{'\n'}
        미사용 유상 다이아는 구매 후 7일 이내 청약철회(환불)할 수 있습니다. 환불 신청은 접수되며 실제 환불은 스토어 정책에 따라 처리되며, 이미 받았거나 사용한 다이아는 환불 금액 계산에 반영됩니다. 자세한 내용은 이용약관(마이페이지)을 확인하세요.
      </Muted>
    </Screen>
  );
}
