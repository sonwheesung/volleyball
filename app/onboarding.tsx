...
const SLIDES: Slide[] = [
  {
    ...
    title: '보는 게임, 배구명가',
    body: '가상 V리그 구단을 수십 시즌 운영하는 구단주입니다. 평소 경기는 감독과 엔진이 자동으로 굴리고, 내 팀 경기와 시즌의 이야기를 관전합니다.',
    bullets: [
      { k: '자동 진행', v: '매 순간 손이 가지 않게. 푸시 알림도 없습니다'},
      { k: '관전이 핵심', v: '중요 경기를 직접 보며 흐름을 즐깁니다' },
      { k: '결과는 실력', v: '경기는 선수 전력·라인업이 좌우해요. 영입·훈련·선발로 다음 경기를 준비하세요' },
    ],
  },
  {
    icon: 'briefcase-outline', tint: theme.elite,
    title: '당신의 역할, 구단주',
    body: '구단주는 프런트에서 큰 결정을 내립니다. 선발과 벤치는 직접 정하고, 내 팀 경기는 볼 때 직접 개입할 수도 있어요.',
    bullets: [
      { k: '직접 결정', v: '재계약·방출·드래프트·FA·외국인·스태프·재정·훈련 방향' },
      { k: '선발·벤치', v: '누구를 주전으로 쓸지 직접 확정(다음 경기부터)' },
      { k: '경기 개입', v: '내 팀 경기는 관전 중 타임아웃·교체 직접(원할 때만)' },
    ],
  },
  {
