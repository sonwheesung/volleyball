    ...
    <Screen title="아시아쿼터 FA">
      ...
      <Card accent={theme.bad} flat>
        ...
        <Muted style={{ fontSize: 12 }}>
          외국인과 별개. 팀당 1명(아시아 국가) · <Text style={{ fontWeight: '800', color: theme.text }}>자유계약</Text>(2026-27~) · 연차 상한 1년 {formatMoney(ASIAN_SALARY_Y1)}·2년 {formatMoney(ASIAN_SALARY_Y2)}(샐러리캡 제외).
