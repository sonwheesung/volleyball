...
// ── (4b) 코스형 전지훈련 (§11.2 개편, 2026-07-02 · 2026-07-08 대칭 +3/+3) — cap99·H1 스탯 구성·비용 200(2026-07-17 인하, 구 300) ──
{
  ...
  const costPass = CAMP_COURSE_COST === 200; // 코스 정액 200(2026-07-17 300→200 인하, CAMP_PER_STAT 구모델 300과 분리)
