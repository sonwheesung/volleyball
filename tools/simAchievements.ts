...
import { evalAchievements, ACHIEVEMENTS, type AchInput } from '../engine/achievements';
...
const opCats = new Set(['cash_200k', 'fan_90']); // 운영 자금·팬심은 리그 시뮬 밖
