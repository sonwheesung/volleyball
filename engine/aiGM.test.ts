...
function mk(id: string, age: number, pos: Position, v = 75): Player {
  ...
  return {
    ...
    clubTenure: 5,
    peakAge: 28,
    career: { seasons: 8, matches: 0, sets: 0, points: 0, spikes: 0, blocks: 0, digs: 0, aces: 0, errors: 0, assists: 0 },
  };
}
...
test('aiFillFromPool: AI팀 빈 포지션을 풀의 OVR 높은 순으로 채우고, 내 팀은 건드리지 않음', () => {
  ...
  const res = aiFillFromPool(rosters, ['o1', 'o2'], snapshot, 'me', () => 'balanced');
